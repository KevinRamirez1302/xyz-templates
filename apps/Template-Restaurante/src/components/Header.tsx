...
export function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Si estamos en el hero (primeros ~700px), mantener transparente
  ...
  return (
    ...
    >
      <nav className="container-custom py-4 flex items-center justify-between">
        ...
        >
          <li>
            <a
              href="#home"
              className={`hover:opacity-70 font-medium transition-opacity duration-300`}
            >
              Inicio
            </a>
          </li>
      ...
      {isOpen && (
        ...
        >
          <ul
            className={`container-custom py-4 space-y-3 transition-colors duration-300 ${
              isTransparent ? 'text-white' : 'text-gray-700'
            }`}
          >
            <li>
              <a
                ...
                className="block hover:opacity-70 font-medium transition-opacity duration-300"
              >
                Inicio
              </a>
            </li>
