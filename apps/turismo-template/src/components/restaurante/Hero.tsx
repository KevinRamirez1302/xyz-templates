import fondoHero from '../../../../Template-Restaurante/src/assets/fondo-hero.jpg'
    ...
    >
      ...
      <div className="container-custom relative z-10 text-center py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#menu" className="btn-primary bg-white text-primary-600 hover:bg-gray-100">Ver Menú</a>
          <a href="#contact" className="btn-secondary border-white text-white hover:bg-white hover:bg-opacity-10">Hacer Reserva</a>
        </div>
      </div>
    </section>
  )
