      ...
      <section className="max-w-4xl mx-auto px-6 py-16 border-t border-slate-200">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-slate-900">Jaime Ensayo</h3>
            <p className="text-slate-600 text-sm">CEO & Fundador</p>
          </div>

          <div className="text-center">
            <div className="w-32 h-32 bg-slate-200 rounded-full mx-auto mb-4"></div>
            <h3 className="text-lg font-medium text-slate-900">Luisa Prueba</h3>
            <p className="text-slate-600 text-sm">Directora de Ventas</p>
          </div>

          <div className="text-center">
            <div className="w-32 h-32 bg-slate-200 rounded-full mx-auto mb-4"></div>
            <h3 className="text-lg font-medium text-slate-900">Testsia Corado</h3>
            <p className="text-slate-600 text-sm">Directora de Recursos Humanos</p>
          </div>
